...
export const metadata: Metadata = {
  title: "Insight | Recommendation Platform",
...
const SignIn: React.FC = () => {
  return (
    <div className="w-screen h-screen bg-slate-600">
      <div className="fixed top-0 w-screen h-screen z-50 bg-slate-600">
        <img className="w-1/2 right-0 h-full" src="/images/hero/hero-bg.png" alt="BACKGROUND"/>
      </div>
      
    <div className="fixed w-full h-full z-99 flex justify-center items-center backdrop-blur-[2px]">
      <div className="rounded-2xl border shadow-default border-strokedark bg-boxdark xl:max-w-[950px] md:w-full sm:w-90 max-w-[650px] h-150 ">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-flex justify-center gap-1" href="/">
                <Image
              ...
              <p className="2xl:px-20">
                Votre outil de gestion, d'analyse et de recommendation de Cvs
                 pour booster le processus de recrutement.
              </p>
          ...
          <div className="w-full border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border  p-4 hover:bg-opacity-50 border-strokedark bg-meta-4 hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
