...
const TestimonialsColumn = (props: {className?:string;
    ...
    <section className="bg-white flex justify-center">
      <div className="container">
        <div className="max-w-[540px] mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-5"> What our users say</h2>
          <p className="text-center text-[22px] leading-[30px] tracking-tight text-[#010D3E] mt-5">
            From intuitive design to powerful features, 
